...
| `ring.glb`      | Generated by `scripts/generate-ring-models.mjs`                                                                                                                     | CC0-1.0 |
| `ring-alt.glb`  | Generated by `scripts/generate-ring-models.mjs`                                                                                                                     | CC0-1.0 |
...
The ring models are generated so the configurator demo has known part and material names
(`Band`, `Stone_Small`, `Stone_Medium`, `Stone_Large`; materials `Band`, `Stone`, `RoseGold`). Both files
share these names, so the demo can swap between them:
